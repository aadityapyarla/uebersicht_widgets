...
render: (output) ->
  ...
  <div class="container">
    <ul class="buttons">
      <li class="button" id="sleep"><img src='/system-control.widget/icons/sleep.png' /></li>
      <li class="button" id="restart"><img src='/system-control.widget/icons/restart.png' /></li>
      <li class="button" id="shutdown"><img src='/system-control.widget/icons/shut-down.png' /></li>
